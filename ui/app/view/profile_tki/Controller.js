Ext.define('koyoku.view.profile_tki.Controller', {
    ...
    load_identitas: function(ths) {
        ...
        if (typeof id != 'undefined') {
            ths.load({
                url: 'http://localhost/project/rkbmd/api/index.php/pekerja/get_by_id',
                params: {
                    ID: id
                },
    ...
    simpan_identitas: function() {
        ...
        if (form.isValid()) {
            ...
            form.submit({
                url: 'http://localhost/project/rkbmd/api/index.php/pekerja/save',
                params: {
    ...
    */
    ...
    save_media: function(ths) {
        ...
        if (form.isValid()) {
            form.submit({
                url: 'http://localhost/project/rkbmd/api/index.php/pekerja/save_media',      
                params:{
                    PEKERJA_ID:me.get_params(1),
                },  
                success: function(form, action) {
