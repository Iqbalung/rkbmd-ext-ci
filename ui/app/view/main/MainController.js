...
Ext.define('koyoku.view.main.MainController', {
    ...
    get_data_viewmodel: function() {
        me = this;
        Ext.Ajax.request({
            url: "http://karya-inovasi.com/beta-rkbmdapi/index.php/app/get_viewmodel",
    ...
    save: function(ths) {
        ...
        if (form.isValid()) {
            form.submit({
                url: 'http://karya-inovasi.com/beta-rkbmdapi/index.php/Pengguna/save',
    ...
    saveupd: function(ths) {
        ...
        if (form.isValid()) {
            form.submit({
                url: 'http://karya-inovasi.com/beta-rkbmdapi/index.php/Pengguna/saveupd',
                success: function(form, action) {
                    var success_opt = true;
                    try {
                        res = Ext.JSON.decode(action.response.responseText);
